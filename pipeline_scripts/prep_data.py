...
def main():
    try:
        ...
        sourcepath = os.path.join(thispath, '../output/')
        ...
        logger.info(f"Loading data from {sourcefilename}")
...
#    firstprep=True
    ...
    oldbahis_preped_data = oldbahis_sourcedata[
        ['date',
            'division',
            'district',
            'upazila',
    ...
    oldbahis_preped_data = oldbahis_preped_data[
        ['basic_info_date',
            'basic_info_division',
            'basic_info_district',
            'basic_info_upazila',
    ...
    bahis_preped_data = bahis_sourcedata[
        ['basic_info_date',
            'basic_info_division',
            'basic_info_district',
            'basic_info_upazila',
    ...
    bahis_preped_data = bahis_preped_data[
        ['basic_info_date',
            'basic_info_division',
            'basic_info_district',
            'basic_info_upazila',
    ...
    lookup_table = pd.read_csv(os.path.join(thispath, "../lookup/", "bahis_data_lovi_top_diagnosis.csv"))
